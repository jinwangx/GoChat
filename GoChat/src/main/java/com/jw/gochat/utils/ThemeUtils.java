...
public class ThemeUtils {
    ...
    public static InputStream getAssetsInputStream(String name){
        ...
        try {
            open = GoChat.getInstance().getContext().getAssets().open(name);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return open;
    ...
    public static ImageView getImageView(){
        ...
        ImageView iv = new ImageView(GoChat.getInstance().getContext());
        iv.setMaxHeight(300);
    ...
    public static TextView getTextView(){
        TextView tv=new TextView(GoChat.getInstance().getContext());
