...
import Lib.core.AuthRequest;
import Lib.core.ChatRequest;
import Lib.core.PacketConnector;
import Lib.future.HttpFuture;
...
public class GoChatManager {
    ...
    public static GoChatManager getInstance() {
        if (instance == null) {
    ...
    private GoChatManager() {
        ...
        client = ChatApplication.getOkHttpClient();
    }
