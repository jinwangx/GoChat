...
public class ConversationFra extends BaseFragment implements AdapterView.OnItemClickListener
    ...
    private FragmentCvstBinding mBinding;

    @Override
    protected View bindView() {
        mBinding = DataBindingUtil.inflate(getActivity().getLayoutInflater(), R.layout.fragment_cvst, null, false);
    ...
    protected void loadData() {
        ...
        mBinding.lvCvst.setAdapter(adapter);
    }

    @Override
    protected void initEvent() {
        super.initEvent();
        mBinding.lvCvst.setOnItemClickListener(this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        bundle.putSerializable("receiver", (Contact) view.getTag());
