...
import com.jw.gochatbase.base.service.BaseService
 ...
 * 3.如果有本地账户，GoimClient类对服务器的连接进行各种监听，并且客户端通过tcp通道开始连接服务器进行认证
 * 4.同时开启后台服务，向服务器提交之前未完成的网络任务
 */

class IMService : BaseService(), PacketConnector.ConnectListener, IMClient.OnPushListener {
    ...
    private val mReceiver = object : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (action == ConnectivityManager.CONNECTIVITY_ACTION) {
                if (NetUtils.isNetConnected(this@IMService)) {
    ...
    private fun connectServer() {
        ...
        if (account != null) {
            ...
            imClient!!.addConnectionListener(this)
            imClient!!.setPushListener(this)
            imClient!!.auth(account.account!!, account.token!!)
    ...
    override fun onDestroy() {
        ...
        // 断开连接
        imClient!!.closeSocket()
        imClient!!.removeConnectionListener(this)
    }
}